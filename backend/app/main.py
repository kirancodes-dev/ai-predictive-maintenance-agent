...
from app.routers import auth, machines, alerts, maintenance, stream, websocket, predictions, technicians, ml, data, insights, fingerprints, isolation
...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {"name": "isolation", "description": "Cascade failure prevention — isolate/release machines, topology"},
    ],
    lifespan=lifespan,
    docs_url="/docs",
    redoc_url="/redoc",
...
app.include_router(isolation.router, prefix="/api/v1")
