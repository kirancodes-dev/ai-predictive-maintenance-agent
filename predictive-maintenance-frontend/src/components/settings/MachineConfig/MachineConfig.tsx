    ...
    <div style={{ padding: '14px 16px', border: '1px solid var(--color-border)', borderRadius: 10,
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
        <div>
          ...
          <div style={{ fontSize: 11, color: 'var(--color-muted)' }}>{meta?.type}</div>
        </div>
        {isLoading ? (
          <span style={{ fontSize: 11, color: 'var(--color-muted)' }}>Analysing…</span>
        ) : (
      ...
      <div style={{ height: 6, borderRadius: 4, background: 'var(--color-surface-alt)', overflow: 'hidden' }}>
